...
<!--                    <i class="fa fa-file-o fa-lg"></i>
                ...
                <div class="card-content">
                    ...
                    {!! Form::open(['url' => '/update-user','method'=>'post','role'=>'form','files' => true, 'enctype' => 'multipart/form-data', 'class'=> 'form-horizontal' ]) !!}
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="input-field">
                                    <input class="form-control" name="user_name" type="text"  value="{{$result-> admin_name}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="input-field">
                                    <input class="form-control" name="user_email" type="email"  value="{{$result->email_address}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="input-field">
                                    <!--<input name="user_password" type="password" value="{{$result->password}}">-->
